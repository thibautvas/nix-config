...
hl.bind("ALT + SEMICOLON", hl.dsp.focus({ workspace = 4 }))
...
hl.bind("ALT + SHIFT + SEMICOLON", hl.dsp.window.move({ workspace = 4 }))
hl.bind("ALT + SHIFT + N", function()
  hl.dispatch(hl.dsp.window.move({ window = "class:" .. browser, workspace = 2 }))
